local function config()
  ...
  helpers.keymap_set_multi({
    {'n', '<leader>s', function() aerial.toggle({ focus = true, direction = 'left' }) end, { desc = 'Aerial: Toggle Sidebar' }},
    {'n', '<leader>a', function() aerial.nav_toggle() end, { desc = 'Aerial: Toggle Nav Window' }},
  })

  helpers.set_hl_multi({
    ['AerialVariableIcon'] = { fg = tc.muted },
  })
  -- stylua: ignore end
  ...
  aerial.setup({
    ...
    keymaps = {
      ...
      ['<F2>.'] = 'actions.jump_vsplit',
      ['<F2>,'] = 'actions.jump_split',
      ['<A-.>'] = 'actions.jump_vsplit',
      ['<A-,>'] = 'actions.jump_split',
      ['o'] = 'actions.scroll',
      ...
      ['zO'] = 'actions.tree_toggle_recursive',
