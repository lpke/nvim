...
helpers.keymap_set_multi({
  ...
  {'nvC', '<D-w>.', 'vsplit', { desc = 'Split window horizontally' }},
  {'nvC', '<C-w>,', 'split', { desc = 'Split window vertically' }},
  {'nvC', '<D-w>,', 'split', { desc = 'Split window vertically' }},
  ...
  {'n', '<D-w>x', Lpke_close_win, { desc = 'Close window (yank info)' }},
  ...
  {'nC', '<D-w>QQ', 'lua require("auto-session").DisableAutoSave() ; vim.cmd("qa")', { desc = 'Quit all without auto-saving session (:qa)' }},
  {'nC', '<C-w>QZ', 'lua require("auto-session").DisableAutoSave() ; vim.cmd("wqa")', { desc = 'Write and quit all without auto-saving session (:wqa)' }},
  {'nC', '<D-w>QZ', 'lua require("auto-session").DisableAutoSave() ; vim.cmd("wqa")', { desc = 'Write and quit all without auto-saving session (:wqa)' }},
  ...
  {'nC', '<D-w>s', 'lua Lpke_win_zoom_toggle()', { desc = '"Zoom" current window horizontally and vertically' }},
  ...
  {'nC', '<D-w>c', 'tabnew', { desc = 'Create a new tab (blank file)' }},
  {'nC', '<C-w>C', 'tab split', { desc = 'Create a new tab (clone current buffer)' }},
  {'nC', '<D-w>C', 'tab split', { desc = 'Create a new tab (clone current buffer)' }},
  {'nC', '<C-w>n', 'tabnew', { desc = 'Create a new tab (blank file)' }},
  {'nC', '<D-w>n', 'tabnew', { desc = 'Create a new tab (blank file)' }},
  {'nC', '<C-w>N', 'tab split', { desc = 'Create a new tab (clone current buffer)' }},
  {'nC', '<D-w>N', 'tab split', { desc = 'Create a new tab (clone current buffer)' }},
  {'nC', '<C-w>&', 'tabclose', { desc = 'Close current tab' }},
  {'nC', '<D-w>&', 'tabclose', { desc = 'Close current tab' }},
  ...
  {'nv', '<D-w><Right>', 'gt', { desc = 'Next Tab (right)' }},
  {'nv', '<C-w><Left>', 'gT', { desc = 'Previous Tab (left)' }},
  {'nv', '<D-w><Left>', 'gT', { desc = 'Previous Tab (left)' }},
  ...
  {'nC', '<D-w>g<Right>', 'tabmove +1', { desc = 'Move Tab Right' }},
  {'nC', '<C-w>g<Left>', 'tabmove -1', { desc = 'Move Tab Left' }},
  {'nC', '<D-w>g<Left>', 'tabmove -1', { desc = 'Move Tab Left' }},
